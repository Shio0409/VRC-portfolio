...
files.push(...avatarPublicFiles, 'src/career.css', 'src/career.js', 'src/career-data.js', 'src/career-clock.js', 'src/contact.css', 'src/sections.css', 'src/contact.js', 'src/contact-data.js', 'src/works.css', 'src/works.js', 'src/works-data.js');
