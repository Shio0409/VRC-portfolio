...
const files = ['index.html', 'favicon.svg', 'src/styles.css', 'src/viewport.css', 'src/app.js', 'src/viewport.js', 'src/entry-flow.js', 'src/assets.js', 'src/top.css', 'src/top.js', 'src/skills.js', 'src/dialogue.js', 'src/top-background.js', 'src/top-parallax.js', 'assets/top-world.webp', 'assets/cursor-normal.svg', 'assets/cursor-hover.svg'];
